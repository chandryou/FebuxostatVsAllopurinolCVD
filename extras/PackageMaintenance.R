...
OhdsiRTools::checkUsagePackage("FebuxostatVsAllopurinolCVD")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/FebuxostatVsAllopurinolCVD.pdf")
shell("R CMD Rd2pdf ./ --output=extras/FebuxostatVsAllopurinolCVD.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("FebuxostatVsAllopurinolCVD")
