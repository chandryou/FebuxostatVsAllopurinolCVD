...
shinyServer(function(input, output, session) {
  ...
  output$downloadAttritionPlot <- downloadHandler(filename = "Attrition.png",
  ...
  output$downloadPsDistPlot <- downloadHandler(filename = "Ps.png",
                                               contentType = "image/png",
                                               content = function(file) {
    device <- function(..., width, height) grDevices::png(...,
                                                          width = width,
  ...
  output$downloadBalancePlot <- downloadHandler(filename = "Balance.png",
                                                contentType = "image/png",
                                                content = function(file) {
      device <- function(..., width, height) grDevices::png(...,
                                                            width = width,
  ...
  output$downloadSystematicErrorPlot <- downloadHandler(filename = "SystematicError.png",
                                                        contentType = "image/png",
                                                        content = function(file) {
      device <- function(..., width, height) grDevices::png(...,
                                                            width = width,
  ...
  output$downloadKaplanMeierPlot <- downloadHandler(filename = "KaplanMeier.png",
                                                    contentType = "image/png",
                                                    content = function(file) {
      device <- function(..., width, height) grDevices::png(...,
                                                            width = width,
